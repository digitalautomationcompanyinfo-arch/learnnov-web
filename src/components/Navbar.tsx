...
export const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: language === 'ar' ? 'لوحة المتفوقين 🏆' : 'Leaderboard 🏆', href: '/leaderboard' },
    { name: language === 'ar' ? 'المختبرات البرمجية 🧪' : 'Interactive Labs 🧪', href: '/labs' },
  ...
  return (
    <header className="glass-panel main-header-shared">
      <div className="header-brand">
        <img src="/logo.png" alt="logo" style={{ height: '45px', width: 'auto', marginRight: '8px' }} />
        <div>
