...
export default function NotificationsPage() {
  ...
  const [items, setItems] = useState<NotificationItem[]>([
    ...
    {
      id: 2,
      title: 'تم قبول طلب التقديم والالتحاق بدورة هندسة الذكاء الاصطناعي',
      titleEn: 'Course Enrollment Application Approved for AI Engineering',
      date: 'منذ يومين',
      read: false,
      icon: '🎓',
      category: 'academic'
    ...
    {
      id: 3,
      title: 'تم إصدار شهادتك الرقمية المعتمدة برمز CERT-9821 بنجاح',
      titleEn: 'Digital Certificate CERT-9821 Issued Successfully',
      date: 'منذ 3 أيام',
      read: true,
      icon: '📜',
